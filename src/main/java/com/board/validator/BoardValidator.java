...
public class BoardValidator implements Validator {
	...
	public boolean supports(Class<?> clazz) {
		...
		//형식)return DTO클래스명.class.isAssignableFrom(claszz);
	...
	public void validate(Object target, Errors errors) {
		...
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "manager_id", "required");
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "e_title", "required");
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "e_content", "required");
		*/
	}
