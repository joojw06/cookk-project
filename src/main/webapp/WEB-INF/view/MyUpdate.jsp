			...
			<div class="profile">
				<div class="container">
					...
					<spring:hasBindErrors name="member" />
						<form action="updateMember.do" class="form-horizontal form-border" id="form" method="post">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" readonly="readonly" class="form-control"
										 name="name" id="input3" placeholder="이름"
										value="${name}">
								</div>
							</div>
							<div class="form-group">
						...
						<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" readonly="readonly" class="form-control "
										name="grade" id="input6" placeholder="등급"
										value="${grade}">
								</div>
							</div>					
							<div class="form-group">
