			 ...
			 <ul>
                  <li>
                    <c:forEach var="review" items="${reviewList}">
                      <a href="r1BoardDetail2.do?board_num=${review.board_num }">
		...
		<div class="table-responsive con_table">
			...
			<c:forEach var="article" items="${list}">	
				<tr>
				    ...
				    <td><a href="r1BoardDetail2.do?board_num=${article.board_num}&mem_id=${mem_id}">[${article.category}]${article.title}</a></td>
				    <td>${writer2}</td>
			...
			<form id="searchForm" class="navbar-form" role="search" action="r1BoardList2.do?mem_id=${mem_id}&writer=${writer}">
