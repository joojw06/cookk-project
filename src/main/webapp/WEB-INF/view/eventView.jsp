	...
	<div class="container mtp-0" style="padding-bottom: 10%;">
		<div class="box mh500">
			...
			<input type="button" class="board_list_btn" style="position: relative; right: 60px;" 
						value="수정" 
						onclick="location.href='eventUpdate.do?event_code=${board.event_code}&manager_id=${manager_id}&writer2=${writer2}'"/>
						        
            <input type="button" class="board_list_btn" style="float:left; position: relative; left:120px;"
            			value="목록보기" 
            			onclick="location.href='eventList.do?manager_id=${manager_id}&writer2=${writer2}'"/>
